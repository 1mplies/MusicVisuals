...
public class Mushroom implements VisualComponent {
    ...
    public void draw() {
        ...
        parent.bezierVertex(mushroomX - capWidth / 2 + controlPointOffset, mushroomY - stemHeight - capHeight, mushroomX + capWidth / 2 - controlPointOffset, mushroomY - stemHeight - capHeight, mushroomX + capWidth / 2, mushroomY - stemHeight);
        parent.endShape();
